		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><button class="btn btn-info" onclick="exit()">Quit</button></li>
				</ul>
			</div>
		</div>
	</nav>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="addproductform"
									...
									<div class="form-group">
										<label for="descriptioninput">image:</label> <input
											type="file" class="form-control" id="descriptioninput"
											name="description"></input>
									</div>
